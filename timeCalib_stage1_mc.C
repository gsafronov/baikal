...
void timeCalib_stage1_mc(string mc_infile="/home/local1/work/baikal/mc/cors-n8x10m-2sec-tr112-thr4.0-1.5.wout", string root_infile="OUT/outout.root",  int calibChanID=10, Bool_t isrec = kTRUE)
{
